...
class Personagem {
    ...
    pocao(quantidade){
        if(this.vivo && this.vida <= this.vidaMaxima){
            this.vida =+ quantidade;
            console.log(`${this.nome} ganhou ${quantidade} de poção, e agora tem ${this.vidaMaxima} de vida`)
            ...
            console.log(`${this.nome} não pode mais se recuperar!`);
        }
...
console.log(personagem2.pocao(30));